...
shell dacpp::list waveEqShell(const dacpp::Tensor<float, 2>& matCur, 
                                const dacpp::Tensor<float, 2>& matPrev, 
                                dacpp::Tensor<float, 2>& matNext) {
...
calc void waveEq(dacpp::Tensor<float, 2>& cur, dacpp::Tensor<float, 1>& prev, dacpp::Tensor<float, 1>& next) {
    next[0] =2.0f*cur[1][1] - prev[0] + c*c*dt*dt*((cur[2][1] -2.0f*cur[1][1]+cur[0][1]/(dx*dx))+(cur[1][2] -2.0f*cur[1][1]+cur[1][0]/(dy*dy)));
